...
const EmployerEditWork = (props) => {
  ...
  const [addWork, setAddWork] = useState({
    ...
    do: data.do ? data.do : "",
    do1: data.do1 ? data.do1 : "",
    do2: data.do2 ? data.do2 : "",
    do3: data.do3 ? data.do3 : "",
    schedule: data.schedule ? data.schedule : "",
    language: data.language ? data.language : "",
    skill: data.skill ? data.skill : "",
    skill1: data.skill1 ? data.skill1 : "",
    skill2: data.skill2 ? data.skill2 : "",
    skill3: data.skill3 ? data.skill3 : "",
    contact: data.contact ? data.contact : "",
    location: data.location ? data.location : "",
    benefit: data.benefit ? data.benefit : "",
    salary: data.salary ? data.salary : "Сонгох",
    gender: data.gender ? data.gender : "Сонгох",
    age: data.age ? data.age : "Сонгох",
    education: data.education ? data.education : "Сонгох",
    experience: data.experience ? data.experience : "Сонгох",
    occupation: data.occupation ? data.occupation : "",
    level: data.level ? data.level : "Мэргэжил хамаарахгүй",
