...
const UserRecievedJobDetail = ({ route }) => {
  ...
  return (
    <View style={{ marginHorizontal: 10, marginTop: 10 }}>
      ...
      <TouchableOpacity
        onPress={() => {
          navigation.navigate("EmployerSendWorkModal", { id: data.createUser });
        }}
        style={{
          padding: 10,
          borderRadius: 10,
...
export default UserRecievedJobDetail;
