...
const EmployeeWorkCallScreen = () => {
  ...
  const getData = () => {
    axios
      .get(
        `${api}/api/v1/announcements?limit=1000&sort=-special -createdAt&certificate=Ажил захиалагч`
      )
      .then((result) => {
        if (isMoutned) {
...
export default EmployeeWorkCallScreen;
